...
To regenerate the Markdown docs you must install the [sphinx-markdown-builder]([https://pypi.org/project/sphinx-markdown-builder/](https://pypi.org/project/sphinx-markdown-builder/))
...
* **Parameters**
    ...
    * **charges** ([*typing.List*](https://docs.python.org/3/library/typing.html#typing.List)*[*[*Charge*](index.md#vast_pdf.Charge)*]*) – the rows on the invoice
