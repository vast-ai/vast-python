...
@parser.command(
    ...
    argument("--create-from",
             ...
             type=str),
    argument("--docker-login-repo",
             help="Docker repository for Docker login. Defaults to docker.io.",
             type=str,
             default="docker.io"),
    argument("--docker-login-username",
            help="Username for Docker login. Must be used together with --docker-login-password",
            type=str),
    argument("--docker-login-password",
            help="Password for Docker login. Must be used together with --docker-login-username",
            type=str),
