...
def list__machine(args):
    ...
    #print("PUT " + req_url);
    r = requests.put(req_url, json = {'machine':args.id, 'price_gpu':args.price_gpu, 'price_disk':args.price_disk, 'price_inetu':args.price_inetu, 'price_inetd':args.price_inetd, 'min_chunk':args.min_chunk  } );
    ...
    if (r.status_code == 200) :
        ...
        if (rj["success"]) :
            ...
            print("offers created for machine {args.id},  @ ${price_gpu_}/gpu/day, ${price_inetu_}/GB up, ${price_inetd_}/GB down, {min_chunk_}/min gpus".format(**locals()));
        else :
            print(rj["msg"]);
    else :
        print(r.text);
