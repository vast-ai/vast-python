...
@parser.command(
    ...
    epilog=deindent("""
        ...
        You can specify a date, duration, reason and category.           
        Example: vastai schedule maint 8207 --sdate 1677562671 --duration 0.5 --maintenance_reason "maintenance reason here as a string that helps clients understand why the maintenance was necessary" --maintenance_category "power"
    """),
    )
